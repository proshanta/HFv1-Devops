...
function networkUp () {
  ...
  CHANNEL_NAME=$CHANNEL_NAME TIMEOUT=$CLI_TIMEOUT docker-compose -f $COMPOSE_FILE -f $COUCH_FILE up -d 2>&1
  if [ $? -ne 0 ]; then
...
function networkDown () {
  docker-compose -f $COMPOSE_FILE -f $COUCH_FILE down
...
COUCH_FILE=docker-compose-couch.yaml
